...
from deep_training.nlp.models.prompt import PromptLearningConfig,PromptArguments
...
class MyRewardTransformer(MyRewardModel,SftWeightMinMax, with_pl=True):
    def __init__(self, *args, **kwargs):
        ...
        prompt_args: PPOConfig = kwargs.pop('prompt_args', None)
...
class MyPPOTransformer(MyAutoModelForSeq2SeqLMWithValueHead,PPOModelLoss,SftWeightMinMax, with_pl=True):
    def __init__(self, *args, **kwargs):
        lora_args: LoraConfig = kwargs.pop('lora_args', None)
        prompt_args: PPOConfig = kwargs.pop('prompt_args', None)
